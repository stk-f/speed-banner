export default function Privacy() {
    return (
        <div style={{ padding: "2rem", maxWidth: "800px", margin: "0 auto", fontFamily: "system-ui" }}>
            ...
            <ul>
                <li>To provide the banner display functionality on your storefront.</li>
                <li>To maintain your subscription and billing status via Shopify.</li>
                <li>To provide you with aggregated performance reports (Dashboard).</li>
            </ul>
            ...
            <h2>5. Contact Us</h2>
            <p>For privacy-related questions, please contact us at: <strong>support@speedbanner.app</strong></p>
        </div>
    );
}
