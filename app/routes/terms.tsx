export default function Terms() {
    return (
        <div style={{ padding: "2rem", maxWidth: "800px", margin: "0 auto", fontFamily: "system-ui" }}>
            ...
            <h2>2. Billing & Subscription</h2>
            <p>Speed Banner offers a 30-day free trial for new users. After the trial ends, you will be billed according to the plan you select (Monthly or Annual). All billing is handled directly by Shopify. You can cancel at any time by uninstalling the app or updating your plan in Shopify.</p>
