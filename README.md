# Speed Banner (Local Dev)

> [!CAUTION]
> **LOCAL GIT SECURITY RULES**
> 1.  **NO SECRETS**: Never commit `.env` or API keys.
> 2.  **NO REMOTE**: Do NOT push to GitHub/GitLab without audit.
> 3.  **PRE-COMMIT**: Run `npm run scan:secrets` before committing.
